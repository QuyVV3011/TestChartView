...
struct HRVHeartRateResultView: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            CustomSliderView(valueCurrent: $valueHRV, valueListLevel: valueListLevel, valueListColor: valueListColor, valueListString: valueListString,showIncrease: .constant(true))
